<template>
  <div class="article_editor_wrapper">
    ...
    ></quill-editor>
    <el-upload ref="upload" :action="qnLocation()"
      :before-upload='beforeUpload' :data="uploadData" :on-success='upScuccess'
    style="display:none;">
...
import {getUploadToken,assignOption,addArticle} from '@/assets/js/connect';
